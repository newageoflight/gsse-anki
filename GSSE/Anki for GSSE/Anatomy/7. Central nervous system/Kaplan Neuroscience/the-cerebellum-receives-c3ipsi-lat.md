...
<div>
  <div>
    ...
    {{c3::<u>ipsi</u>}}<u>-lateral</u> proprioceptive information
    from the <b>{{c1::spinal cord}}</b> via the <b>{{c2::inferior
    cerebellar}}</b> <b>peduncle</b>
  </div>
</div>

### Extra
<i>processed in the vermis and intermediate hemisphere</i>
