...
### Text
<div>
  <b>{{c3::Upper}} motor neuron lesions</b> of the <u>facial
  nerve</u> result in <i>{{c2::contra}}-lateral</i> paralysis of
  the <b>{{c1::lower}} muscles</b> of facial expression
</div>

### Extra
<div>
  <i>e.g. destruction of motor cortex or connection between motor
  cortex and facial nucleus; forehead is spared due to bilateral
  UMN innervation</i>
</div>
