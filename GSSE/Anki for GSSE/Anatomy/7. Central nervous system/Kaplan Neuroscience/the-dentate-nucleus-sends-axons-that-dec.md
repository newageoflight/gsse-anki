...
<div>
  <div>
    The <b>dentate nucleus</b> sends axons that <i>decussate</i> in
    the <b>{{c1::superior cerebellar peduncle}}</b> and then
    synapse in the <i>contralateral</i> <b>{{c2::ventral lateral
    (VL)}} nucleus</b> of the thalamus
  </div>
</div>
